...
from app.schemas.rule import MatchCriterion, AssociationMatchCriterion, TagModification 
...
from app.worker.action_applicator import apply_actions_for_rule, ruleset_name_for_log # Re-use helper
...
def process_instance_against_rules(
    ...
    db_session: 'Session', # For crosswalk and other potential DB needs during processing
    ...
    for ruleset in active_rulesets:
        ...
        for rule in rules_in_this_ruleset:
            ...
            if tag_conditions_met and assoc_conditions_met:
                ...
                # Dataset to pass to actions; use modified_ds if it exists, else original_ds (if no copy was made)
                ...
                destinations_from_this_rule = collect_destinations_for_rule(rule)
